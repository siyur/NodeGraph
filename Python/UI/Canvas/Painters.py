...
from Python.Core.UICommon import NodeDefaults, findPinClassByType
from Python.Core.Common import PinDirection

from Python.UI.Utils.stylesheet import editableStyleSheet, Colors
    ...
    def default(node, painter, option, widget):
        ...
        if node.draw_label:
            ...
            if lod < SWITCH_LOD:
                ...
                b.setColorAt(0.5, head_color)
                b.setColorAt(1, head_color.darker(50))
                ...
                painter.fillRect(lr, head_color)
