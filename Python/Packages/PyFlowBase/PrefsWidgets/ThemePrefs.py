...
from Python.UI.Widgets.PropertiesFramework import CollapsibleFormWidget, PropertiesWidget
from Python.Core.UICommon import clearLayout
from Python.UI.Widgets.QtSliders import pyf_ColorSlider, pyf_Slider
from Python.UI.Utils.stylesheet import editableStyleSheet, ConnectionTypes
from Python.UI.Widgets.PreferencesWindow import *
