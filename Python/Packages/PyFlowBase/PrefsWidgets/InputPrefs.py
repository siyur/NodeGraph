...
from Python.Input import InputAction, InputManager
from Python.UI.Widgets.PropertiesFramework import CollapsibleFormWidget, PropertiesWidget
from Python.UI.Widgets.PreferencesWindow import CategoryWidgetBase
from Python.UI.Widgets.InputActionWidget import InputActionWidget
