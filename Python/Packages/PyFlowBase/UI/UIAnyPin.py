...
from Python import findPinClassByType
from Python.UI.Widgets.SelectPinDialog import SelectPinDialog
...
class UIAnyPin(UIPinBase):
    def __init__(self, owningNode, raw_pin):
        """UI wrapper for :class:`Python.Packages.PyFlowBase.Pins.AnyPin`

        :param owningNode: Owning node
        :type owningNode: :class:`Python.UI.Canvas.NodeBase`
        :param raw_pin: PinBase reference
        :type raw_pin: :class:`Python.Packages.PyFlowBase.Pins.AnyPin`
        """
